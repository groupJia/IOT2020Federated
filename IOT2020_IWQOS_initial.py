...
def KeyGen():
    ...
    g1 = Element(pairing, G2, value=g ** alp)
    g2 = Element(pairing, G2, value=g ** beta)
    ...
    gq1 = Element(pairing, G2, value=g ** q1)
    q2 = func_qqqq(pairing, Zr, 2, beta, xishu1, xishu2, xishu3)
    gq2 = Element(pairing, G2, value=g ** q2)
    q3 = func_qqqq(pairing, Zr, 3, beta, xishu1, xishu2, xishu3)
    gq3 = Element(pairing, G2, value=g ** q3)
    ####################生成公钥和私钥
    # 公钥
    PK = [g, g1, g2, gq1, gq2, gq3]
    ...
    sk0_2 = Element(pairing, G2, value=(g ** qt0) ** r)
    sk0_3 = Element(pairing, G2, value=g ** r)
    sk0_4 = t
    SK0 = [sk0_1, sk0_2, sk0_3, sk0_4]
    return PK,SK0,pairing,xishu1,xishu2,xishu3,beta
...
print('broker_task_M',broker_task_M)
...
#########生成公私密钥和相应参数
PK,SK0,pairing,xishu1,xishu2,xishu3,beta=KeyGen()
list1=[PK,SK0,pairing,xishu1,xishu2,xishu3,beta]
print('list1',list1)
Public_parameter_set.append(list1)
#存成字典
sk_set=[]
for i in range(brokernumber):
    tagnew=get_random_prime(10)
...
#########生成公私密钥和相应参数
PK,SK0,pairing,xishu1,xishu2,xishu3,beta=KeyGen()
list2=[PK,SK0,pairing,xishu1,xishu2,xishu3,beta]
...
#########生成公私密钥和相应参数
PK,SK0,pairing,xishu1,xishu2,xishu3,beta=KeyGen()
list3=[PK,SK0,pairing,xishu1,xishu2,xishu3,beta]
...
#########生成公私密钥和相应参数
PK,SK0,pairing,xishu1,xishu2,xishu3,beta=KeyGen()
list4=[PK,SK0,pairing,xishu1,xishu2,xishu3,beta]
...
#########生成公私密钥和相应参数
PK,SK0,pairing,xishu1,xishu2,xishu3,beta=KeyGen()
list5=[PK,SK0,pairing,xishu1,xishu2,xishu3,beta]
...
#########生成公私密钥和相应参数
PK,SK0,pairing,xishu1,xishu2,xishu3,beta=KeyGen()
list6=[PK,SK0,pairing,xishu1,xishu2,xishu3,beta]
...
# broker_key=[b1,b2,b3,b4,b5]
# broker_key=[b1,b2,b3,b4,b5,b6,b7]
# broker_key=[b1,b2,b3,b4,b5,b6,b7,b8]
# #
# broker_key=[b1,b2,b3,b4,b5,b6,b7,b8,b9]
# broker_key=[b1,b2,b3,b4,b5,b6,b7,b8,b9,b10]
# broker_key=[b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11]
...
PK, SK0, pairing, xishu1, xishu2, xishu3, beta=Public_parameter_set[2]
print(Public_parameter_set[2])
print(PK)
print(SK0)
print(xishu1)
print(xishu2)
